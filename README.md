...
1. Ter o [sql](https://docs.microsoft.com/pt-br/sql/database-engine/install-windows/install-sql-server?view=sql-server-ver15) instalado.
...
# Habilidades
Neste projeto,é verificado se o estudante é capaz de:
